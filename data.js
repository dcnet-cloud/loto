...
const riddleData = {
  ...
  6: ['Con côn trùng có mấy chân?', 'Đàn guitar có mấy dây?'],
  7: ['Cầu vồng có mấy sắc màu?', 'Một tuần lễ có mấy ngày?'],
  ...
  11: ['Đội bóng đá mỗi bên ra sân mấy cầu thủ?'],
  12: ['Một năm có mấy tháng?', 'Trên mặt đồng hồ có mấy con số?'],
  13: ['Số mấy bị xem là xui xẻo ở phương Tây?', 'Thứ sáu ngày mấy là ngày xui?'],
  14: ['Ngày Valentine là ngày mấy tháng hai?'],
  15: ['Một khắc đồng hồ bằng mấy phút?'],
  16: ['Bốn nhân bốn bằng mấy?'],
  18: ['Mấy tuổi được coi là trưởng thành ở Việt Nam?'],
  20: ['Một chục đôi là bao nhiêu?'],
  ...
  28: ['Tháng hai thường có mấy ngày?'],
  29: ['Tháng hai năm nhuận có mấy ngày?'],
  30: ['Tháng tư có mấy ngày?'],
  31: ['Tháng một có mấy ngày?'],
  32: ['Nước đóng băng ở mấy độ Fahrenheit?'],
  36: ['Sáu nhân sáu bằng mấy?'],
  37: ['Thân nhiệt bình thường của cơ thể người khoảng mấy độ C?'],
  40: ['Ali Baba và mấy tên cướp?'],
  48: ['Bốn chục rưỡi cộng ba bằng mấy?'],
  50: ['Nửa thế kỷ là mấy năm?'],
  52: ['Một năm có bao nhiêu tuần lễ?'],
  54: ['Bộ bài tây có mấy lá bài?'],
