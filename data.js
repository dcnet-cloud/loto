...
const riddleData = {
  ...
  9: ['Con mèo có mấy mạng?', 'Ba nhân ba bằng mấy?'],
  ...
  17: ['Số nguyên tố nằm giữa mười ba và mười chín là số mấy?'],
  18: ['Mấy tuổi được coi là trưởng thành ở Việt Nam?', 'Tuổi được đi bầu cử là mấy?'],
  19: ['Cách mạng tháng Tám diễn ra ngày mấy?', 'COVID mười chín, số mấy đứng sau chữ COVID?'],
  20: ['Bốn nhân năm bằng mấy?', 'Hai mươi ngón tay chân cộng lại, mấy ngón?'],
  21: ['Trong bài Xì Dách, điểm lớn nhất không bị quắc là mấy?'],
  22: ['Hai con vịt song song là số mấy?', 'Catch hai hai là thuật ngữ nổi tiếng, số mấy trong đó?'],
  ...
  27: ['Ba mũ ba bằng mấy?', 'Chín nhân ba bằng mấy?'],
  ...
  33: ['Tuổi của Chúa Jesus khi chịu nạn là mấy?', 'Mười một nhân ba bằng mấy?'],
  34: ['Hai nhân mười bảy bằng mấy?'],
  ...
  41: ['Bốn mươi cộng một bằng mấy?'],
  42: ['Sáu nhân bảy bằng mấy?'],
  43: ['Năm mươi trừ bảy bằng mấy?'],
  ...
  53: ['Herbie, chiếc xe con bọ nổi tiếng mang số mấy?'],
